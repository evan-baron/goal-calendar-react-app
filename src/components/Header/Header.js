  ...
  return (
    <>
        ...
        <header className='header'>
            <h1 className='hero-text'>Reward yourself<br></br>for completing <b>your</b> goals.</h1>
            <h3 className='hero-description'>Set your goal.<br></br>Pick your reward.<br></br>EARN IT.</h3>
